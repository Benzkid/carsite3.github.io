(function(sttc) {
    ...
    */
    ...
    function la(a) {
        return a instanceof Array ? a : ka(u(a))
    }
    ...
    t("Promise", function(a) {
        ...
        b.prototype.then = function(g, h) {
            function k(v, A) {
                return "function" == typeof v ? function(K) {
                    try {
                        l(v(K))
                    } catch (B) {
                        m(B)
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), m = l.next(); !m.done; m = l.next()) d(m.value).la(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
            ...
            return k.done ? d([]) : new b(function(l, m) {
                ...
                var v = [],
                    A = 0;
                do v.push(void 0), A++, d(k.value).la(q(v.length - 1), m), k = h.next();
                while (!k.done)
            })
        };
        return b
    ...
    function ob(a, b) {
        Object.isFrozen(a) || (nb ? a[nb] |= b : void 0 !== a.X ? a.X |= b : Object.defineProperties(a, {
            X: {
                value: b,
                configurable: !0,
                writable: !0,
    ...
    function tb(a, b) {
        ...
        b ? ob(a, 8) : Object.isFrozen(a) || (nb ? a[nb] &= -9 : void 0 !== a.X && (a.X &= -9))
    };

    function ub(a) {
        return null !== a && "object" === typeof a && !Array.isArray(a) && a.constructor === Object
    }
    var vb, wb = Object.freeze(qb([]));

    function xb(a) {
        if (rb(a.u)) throw Error("Cannot mutate an immutable Message");
    }
    var yb = "undefined" != typeof p.Symbol && "undefined" != typeof p.Symbol.hasInstance;
    ...
    function Eb(a, b) {
        for (var c = a.slice(), d = 0; d < c.length; d++) c[d] = Fb(c[d], b);
        Array.isArray(a) && pb(a) & 1 && qb(c);
        return c
    }
    ...
    function Db(a) {
        if ("object" === typeof a) {
            if (jb && null != a && a instanceof Uint8Array) return new Uint8Array(a);
            if (Array.isArray(a.u) && a.constructor !== Object) {
                var b = Cb(a.u);
                Hb = b;
    ...
    function Jb(a) {
        return a.i || (a.i = a.u[a.j + a.T] = {})
    }

    function z(a, b, c) {
        return -1 === b ? null : b >= a.j ? a.i ? a.i[b] : void 0 : (void 0 === c ? 0 : c) && a.i && (c = a.i[b], null != c) ? c : a.u[b + a.T]
    }

    function C(a, b, c, d, e) {
        d = void 0 === d ? !1 : d;
        (void 0 === e ? 0 : e) || xb(a);
        if (b >= a.j || d) return Jb(a)[b] = c, a;
        void 0 !== a.i && a.j >= a.u.length ? (d = a.u.length - 1, e = b + a.T, e >= d ? (a.u[d] = void 0, a.u[e] = c, a.u.push(a.i)) : a.u[e] = c) : a.u[b + a.T] = c;
        void 0 !== a.i && b in a.i && delete a.i[b];
        return a
    }

    function Kb(a, b) {
        return Array.isArray(z(a, Lb(a, Mb, b)))
    }
    ...
    function Nb(a, b, c, d) {
        ...
        if (rb(a.u)) c && (sb(e), Object.freeze(e));
        else if (e === wb || rb(e)) e = qb(e.slice()), C(a, b, e, d);
        return e
    }
    ...
    function Sb(a, b, c, d) {
        xb(a);
        (c = Tb(a, c)) && c !== b && null != d && (a.h && c in a.h && (a.h[c] = void 0), C(a, c));
        return C(a, b, d)
    }
    ...
    function F(a, b, c, d) {
        ...
        var f = a.h[c];
        if (f) b = f;
        else if (b = Ab(z(a, c, e), b)) a.h[c] = b, rb(a.u) && sb(b.u);
        if (null == b) return b;
        rb(b.u) && !rb(a.u) && (b = b.xa(), C(a, c, b.u, d), a.h[c] = b);
        return b
    }
    ...
    function G(a, b, c, d) {
        ...
        b = l || g;
        g = rb(k);
        b && !g && (Object.isFrozen(k) && (a.h[c] = k = k.slice()), sb(k), Object.freeze(k));
        !b && g && (a.h[c] = k = k.slice());
        a = Nb(a, c, d);
        if (!(c = e) && (c = a)) {
        ...
        if (c) {
            for (c = 0; c < k.length; c++)(d = k[c]) && rb(d.u) && !e && (k[c] = k[c].xa(), a[c] = k[c].u);
            tb(a, !0)
        }
        return k
    }
    ...
    function Yb(a, b, c) {
        return D(a, Lb(a, c, b), 0)
    }

    function Zb(a, b, c, d) {
        return F(a, b, Lb(a, d, c))
    };
    ...
    function $b(a, b, c) {
        ...
        a || (a = f ? [f] : []);
        e && 0 < a.length && ub(a[a.length - 1]) && "g" in a[a.length - 1] && (d = 0);
        this.T = (f ? 0 : -1) - d;
        this.h = void 0;
        this.u = a;
        a: {
            d = this.u.length;a = d - 1;
            if (d && (d = this.u[a], ub(d))) {
                this.i = d;
                b = r(Object, "keys").call(Object, d);
                if (d = 0 < b.length) b: {
                    d = isNaN;f = b.length;
                    for (var g = "string" === typeof b ? b.split("") : b, h = 0; h < f; h++)
                        if (h in g && !d.call(void 0, g[h], h, b)) {
                            d = !1;
                            break b
                        }
                    d = !0
                }
                d ? this.j = Number.MAX_VALUE : this.j = a - this.T;
                break a
            }
            void 0 !== b && -1 < b ? (this.j = Math.max(b, a + 1 - this.T), this.i = void 0) : this.j = Number.MAX_VALUE
        }
        if (!e && this.i && "g" in this.i) throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');
        if (c)
            for (e = 0; e < c.length; e++) a = c[e], a < this.j ? (a += this.T, (b = this.u[a]) ? Array.isArray(b) && qb(b) : this.u[a] = wb) : (b = Jb(this), (d = b[a]) ? Array.isArray(d) && qb(d) : b[a] = wb)
    }
            ...
            for (var d in c)
                if (Object.prototype.hasOwnProperty.call(c, d)) {
                    ...
                    if (e) {
                        ...
                        if (Array.isArray(e)) {
                            if (e.length)
                                for (f = G(a, e[0].constructor, g, f), g = 0; g < Math.min(f.length, e.length); g++) Ib(f[g], e[g])
                        } else(f = F(a, e.constructor, g, f)) && Ib(f, e)
                    }
                }
        }
    }
    ...
    if (yb) {
        var dc = {};
        Object.defineProperties(cc, (dc[p.Symbol.hasInstance] = zb(function() {
            throw Error("Cannot perform instanceof checks for MutableMessage");
        }), dc))
    };

    function ec(a, b, c, d, e, f) {
        (a = a.h && a.h[c]) ? Array.isArray(a) ? (e = f.ta ? qb(a.slice()) : a, Wb(b, c, e)) : Ub(b, c, a): (jb && d instanceof Uint8Array ? e = d.length ? new mb(new Uint8Array(d)) : lb || (lb = new mb(null)) : (Array.isArray(d) && (e ? sb(d) : Array.isArray(d) && pb(d) & 1 && f.ta && (d = d.slice())), e = d), C(b, c, e))
    };
    ...
    H.prototype.xa = function() {
        if (rb(this.u)) {
            ...
            this.ga && (c.ga = this.ga.slice());
            for (var d = this.u, e = 0; e < d.length; e++) {
                var f = d[e];
                if (e === d.length - 1 && ub(f))
                    for (var g in f) {
                        if (Object.prototype.hasOwnProperty.call(f, g)) {
                            var h = +g;
                            r(Number, "isNaN").call(Number, h) ? Jb(c)[g] = f[g] : ec(this, c, h, f[g], b, a)
                        }
                    } else ec(this, c, e - this.T, f, b, a)
            }
            a = c
        } else a = this;
        return a
    ...
    if (yb) {
        var fc = {};
        Object.defineProperties(H, (fc[p.Symbol.hasInstance] = zb(Object[p.Symbol.hasInstance]), fc))
    };
    ...
    */
    ...
    function de(a) {
        ...
        b.forEach(function(e) {
            c = c.concat(e.Oa || []);
            d = r(Object, "assign").call(Object, d, e.Xa)
        });
        return new ce(c, d)
    }
    ...
    var Ke = new N(1084),
        ...
        Ff = new N(1197),
        Gf = new N(1190),
        Hf = new Je(1934, ["",
    ...
    function Q(a) {
        return P(Rf).i(a.h, a.defaultValue)
    }

    function R(a) {
        return P(Rf).j(a.h, a.defaultValue)
    }

    function Sf() {
        return P(Rf).l(Oe.h, Oe.defaultValue)
    };
    ...
    function Fh(a, b, c, d, e) {
        ...
        Ua(b, function(h) {
            ...
            Ua(a, function(l) {
                ...
                if (q) {
                    var v, A, K;
                    var B = null != (K = null == (v = P(xh).h.get(h)) ? void 0 : null == (A = v.get(q)) ? void 0 : A.slice(0)) ? K : [];
                    a: {
                        v = new hh;
                        switch (m) {
                            case 1:
    ...
    function Hh() {
        return Wa(r(Object, "keys").call(Object, P(xh).i), function(a) {
            return Number(a)
        })
    }
    ...
    function gi(a) {
        ...
        di(Zh, function(b) {
            for (var c = P(rh), d = u([zg, Ag, Bg]), e = d.next(); !e.done; e = d.next()) e = e.value, r(Object, "assign").call(Object, c.h[e], b[e])
        }, a)
    }
    ...
    function dj(a, b, c, d, e) {
        ...
        return function() {
            ...
            try {
                ...
                f.google_measure_js_timing && h && cj(r(Object, "assign").call(Object, {}, {
                    label: a.toString(),
                    value: h,
                    duration: (pi() || 0) - h,
                    type: k
    ...
    function gj(a) {
        if (!a) return null;
        var b = z(a, 7);
        if (z(a, 1) || a.getId() || 0 < Nb(a, 4).length) {
            var c = a.getId();
            b = Nb(a, 4);
            var d = z(a, 1),
                e = "";
    ...
    function pj(a, b) {
        ...
        b.forEach(function(e) {
            ...
            } else Zb(e, le, 2, ne) ? rj(a, Zb(e, le, 2, ne), c) : Zb(e,
                me, 3, ne) && sj(a, Zb(e, me, 3, ne), d)
        });
        return new oj(c, d)
    }
        ...
        if (k) {
            b: {
                var l = {
                    ...
                    v = Fj(e, "ins.adsbygoogle[data-ad-format=autorelaxed]");
                ...
                var K = Fj(e, "div.trc_related_container,div.OUTBRAIN,div[id^=rcjsload],div[id^=ligatusframe],div[id^=crt-],iframe[id^=cto_iframe],div[id^=yandex_], div[id^=Ya_sync],iframe[src*=adnxs],div.advertisement--appnexus,div[id^=apn-ad],div[id^=amzn-native-ad],iframe[src*=amazon-adsystem],iframe[id^=ox_],iframe[src*=openx],img[src*=openx],div[class*=adtech],div[id^=adtech],iframe[src*=adtech],div[data-content-ad-placement=true],div.wpcnt div[id^=atatags-]"),
                    ...
                    T = Fj(e, "html > ins.adsbygoogle");k = [].concat(Fj(e, "iframe[id^=aswift_],iframe[id^=google_ads_frame]"), Fj(e, "body ins.adsbygoogle"));h = [];l = u([
                    [l.Wb, m],
                    [l.ob, q],
                    [l.Zb, v],
                    [l.Xb, A],
                ...
                m = q.next().value,
                q = q.next().value,
                !1 === m ? h = h.concat(q) : k = k.concat(q);k = Gj(k);l = Gj(h);h = k.slice(0);k = u(l);
    ...
    function Kj(a, b, c, d) {
        ...
        c = F(b, oe, 3);
        f = {};
        c && (f.eb = z(c, 1), f.Ma = z(c, 2), f.lb = !!Ob(c, 3));
        ...
        a: {
            try {
                ...
                (B = f.ua) && B.parentNode && (I = B.parentNode, I.removeChild(B),
    ...
    n.I = function(a, b, c, d, e) {
        ...
        try {
            ...
            var v = new Pj(x.location.href, x, !1);
            k = null;
            var A = b.length - 1;
            for (q = A; 0 <= q; --q) {
                var K = b[q];
    ...
    function sk(a) {
        ...
        if (a = (void 0 === a.oa ? 0 : a.oa) || !nk(new mk(b))) {
            if (!d) {
                if (!(c = !c))
    ...
    function am(a, b) {
        return b ? Kb(b, 13) ? E(Zb(b, Il, 13, Mb), 1) : Kb(b, 14) && "" !== a && 1 === Nb(Wl(b), 1).length && Nb(Wl(b), 1)[0] === a ? E(F(Wl(b), Il, 2), 1) : !1 : !1
    }
    ...
    function im(a) {
        Q(Ke) && Xj("abg_adsensesettings_lserr", {
            s: a,
            g: Q(Le),
            c: Yl(),
            r: .01
    ...
    function xm(a) {
        ...
        a: {
            ...
            if (null == a ? 0 : Kb(a, 13)) {
                var d, e;
                b = (b = null == a ? void 0 : null == (d = Zb(a, Il, 13, Mb)) ? void 0 : null == (e = F(d, zk, 2)) ? void 0 : F(e, Ak, 2)) && 0 < G(b, pe, 1).length ? b : null
            } else {
                if (null == a ? 0 : Kb(a, 14)) {
                    var f;
                    d = null == a ? void 0 : null == (f = Wl(a)) ? void 0 : Nb(f, 1);
                    var g, h, k;
                    e = null == a ? void 0 : null == (g = Wl(a)) ? void 0 : null == (h = F(g, Il, 2)) ? void 0 : null == (k = F(h, zk, 2)) ? void 0 : F(k, Ak, 2);
                    if (d && 1 === d.length && d[0] === c && e && 0 < G(e, pe, 1).length && Xb(a, 17) === b.location.host) {
                        b =
                            e;
                        break a
                    }
        ...
        b ? (c = new we, g = G(b, pe, 1), c = Wb(c, 1, g), b = G(b, ze, 2), b = Wb(c, 7, b), b = Rd(b)) : b = Td(Error("invtag"));
        return b
    }
    ...
    function Km(a) {
        ...
        Q(df) && (c.easpf = !0, c.easpi = Q(sf), Q(qf) && (c.easpa = !0), c.asntp = R(Ue), c.asntpv = R(Ye), c.asntpl = R(We), c.asntpm = R(Xe), c.asntpc = R(Ve), c.asna = R(Qe), c.asnd = R(Re), c.asnp = R(Se), c.asns = R(Te), c.asmat = R(Pe), c.asptt = R(Ze));
    ...
    function Nm(a) {
        Q(Ef) ? qm(a.h, a.j, a.i.google_ad_client || "", function(b) {
            var c = a.h,
                d = a.i;
    ...
    function Pm(a, b, c) {
        if (Array.isArray(z(c, 24))) {
            ...
            d.availableAbg = !0;
            var e, f;
            d.ablationFromStorage = !!(null == (e = F(c, re, 24)) ? 0 : null == (f = F(e, te, 3)) ? 0 : Zb(f, ue, 2, ve))
        }
        if (Lm(b) && (d = xl(a, G(c, ze, 7)), !d || !Ob(d, 8))) return;
        V(L).ama_ran_on_page = !0;
        var g;
        if (null == (g = F(c, Ee, 15)) ? 0 : Ob(g, 23)) V(a).enable_overlap_observer = !0;
        if ((g = F(c, Ce, 13)) && 1 === z(g, 1)) {
            var h = 0,
                k = F(g, De, 6);
            k && z(k, 3) && (h = z(k, 3) || 0);
            lm(a, h)
        } else if (null == (h = F(c, re, 24)) ? 0 : null == (k = F(h, te, 3)) ? 0 : Zb(k, ue, 2, ve)) lj(a).ablatingThisPageview = !0, lm(a,
            1);
        vd(3, [c.toJSON()]);
    ...
    */
    ...
    function Wm() {
        for (var a = L.document, b = u([yd(Um), yd(Vm)]), c = b.next(); !c.done; c = b.next()) {
            c = c.value;
    ...
    function an() {
        var a = P(Rf).h(Hf.h, Hf.defaultValue),
            b = L.document;
    ...
    function fn(a, b, c) {
        ...
        Ua(e, function(q) {
            var v = new dh;
            if (q = hn(a, q, c, v)) 0 !== Tb(v, eh) && l.push(v), v = q.getId(), d.push(v), jn(a, v, k ? 4 : c), (q = G(q, Kg, 2)) && (k ? Fh(q, Hh(), a.h, v) : Fh(q, [c], a.h, v))
        });
        var m;
    ...
    function An(a, b, c) {
        ...
        if (d.plle) yn(1, $m(a));
            ...
            if (c = Xb(b, 15)) c = Number(c), P(ii).l(c);
            b = u(Nb(b, 19));
    ...
    function go(a, b, c, d, e) {
        ...
        A = Mi(d, c, "zIndex") || "";
        return new On(v, g, q, null, m, f, h, K, B, l, k, A)
    }
    ...
    function ho(a, b, c, d, e, f) {
        ...
        l = Vj(248, function() {
            ...
            a: if (f) {
                ...
                A = K.call(A, v, B);
                if (A < .5 * v || 100 > A) A = v;
                Q(Bf) && !Pi(d, c) && (A = Math.max(A, .5 * ng(c).clientHeight));
                v = {
    ...
    function jo(a) {
        return Q(zf) || a.location && "#hffwroe2etoq" == a.location.hash
    };
    ...
    function lo(a, b, c, d, e) {
        ...
        a = ho(f, "auto", b, c, e, !0);
        return new On(1, a.aa, a.ra, 2, !0, g, a.Y)
    };
    ...
    function mo(a, b) {
        ...
        if ("autorelaxed" == c) {
            a: {
                if ("pedestal" != b.google_content_recommendation_ui_type)
                    for (a = u(Qn), c = a.next(); !c.done; c = a.next())
                        if (null != b[c.value]) {
                            b = !0;
                            break a
                        }
        ...
        if ("link" === c) return 4;
        if ("fluid" == c) {
            if (c = "in-article" === b.google_ad_layout) c = Q(zf) || a.location && ("#hffwroe2etop" == a.location.hash || "#hffwroe2etoq" == a.location.hash);
            return c ? (no(b), 1) : 8
        }
    ...
    function No(a) {
        a = a.id;
        return null != a && (Mo().has(a) || r(a, "startsWith").call(a, "google_ads_iframe_") || r(a, "startsWith").call(a, "aswift"))
    }
    ...
    function Uo() {
        ...
        this.za = this.Ba = this.Ca = this.Ea = this.Ja = this.m = this.Ia = this.V = 0;
        this.Aa = !1;
            ...
            for (var e = b.next(); !e.done; e = b.next()) switch (e = e.value, e.entryType) {
                case "layout-shift":
                    ...
                    if (!e.hadRecentInput) {
                        ...
                        f.h += e.value;
                        g && (f.i += e.value);
                        f.h > f.V && (f.V = f.h, f.Ja = f.i, f.Ia = e.startTime + e.duration)
                    }
                    break;
    ...
    function bp(a) {
        if (!a.Fa) {
            ...
            window.LayoutShift && (b += Lo("cls", a.H), b += Lo("mls", a.O), b += Ko("nls", a.P), window.LayoutShiftAttribution && (b += Lo("cas", a.m), b += Ko("nas", a.Ea)), b += Lo("wls", a.V), b += Lo("tls", a.Ia), window.LayoutShiftAttribution && (b += Lo("was", a.Ja)));
            window.LargestContentfulPaint && (b += Ko("lcp", a.Ca), b += Ko("lcps", a.Ba));
            window.PerformanceEventTiming && a.Aa && (b += Ko("fid", a.za));
            window.PerformanceLongTaskTiming &&
                (b += Ko("cbt", a.D), b += Ko("mbt", a.J), b += Ko("nlt", a.R));
            for (var c = 0, d = u(document.getElementsByTagName("iframe")), e = d.next(); !e.done; e = d.next()) No(e.value) && c++;
            b += Ko("nif", c);
            b += Ko("ifi", Ad(window));
            c = P(ii).i();
            b += "&eid=" + encodeURIComponent(c.join());
            b += "&top=" + (x === x.top ? 1 : 0);
            b += a.Ha ? "&qqid=" + encodeURIComponent(a.Ha) : Ko("pvsid", qd(x));
    ...
    function cp(a, b, c) {
        ...
        b && dp() && this.h.push(X);
        c && this.h.push(Y);
        if (document.hasTrustToken && !Q(Mf)) {
            var e = new p.Map;
            this.h.forEach(function(f) {
    ...
    function ep() {
        ...
        var b = P(Rf).h(Pf.h, Pf.defaultValue);
        pd(b, a)
    }
    ...
    function kp(a) {
        if (document.hasTrustToken && !Q(Mf) && a.i) {
    ...
    var mp = [10, 6];
    var wp = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    ...
    function yp() {
        ...
        a = L.navigator.userAgentData.getHighEntropyValues(wp).then(function(d) {
    ...
    function zp(a) {
        var b;
        return tp(sp(rp(qp(pp(op(np(up(new lp, a.platform || ""), a.platformVersion || ""), a.architecture || ""), a.model || ""), a.uaFullVersion || ""), a.bitness || ""), (null == (b = a.fullVersionList) ? void 0 : b.map(function(c) {
            var d = new vp;
            d = C(d, 1, c.brand);
    ...
    function Ap() {
        var a, b;
        return null != (b = null == (a = yp()) ? void 0 : a.then(function(c) {
            return zp(c)
        })) ? b : null
    };
    ...
    function Cp(a, b, c) {
        ...
        L.google_sa_queue || (L.google_sa_queue = [], L.google_process_slots = Wj(215, function() {
            return Dp(L.google_sa_queue)
        }), a = Ep(c, a, b), Wc(L.document, a).id = "google_shimpl")
    }
    ...
    function Ep(a, b, c) {
        var d = Math.random() < R(vf) ? zc(yc(b.zb).toString()) : null;
        b = E(c, 4) ? b.yb : b.Ab;
        ...
        Gp(c, b);
        a: {
            if (!Q(df) && (Q(sf) || Q(cf)) && (a = a || Ho(L), c = om(L), a)) {
                e = {};
                a = (e.client = a, e.plah = L.location.host, e.ama_t = "adsense", e.asntp = R(Ue), e.asntpv = R(Ye), e.asntpl = R(We), e.asntpm = R(Xe), e.asntpc = R(Ve), e.asna = R(Qe), e.asnd = R(Re), e.asnp = R(Se), e.asns =
                    R(Te), e.asmat = R(Pe), e.asptt = R(Ze), e.easpi = Q(sf), e.asro = Q($e), e.host = c, e.easai = Q(qf), e);
                break a
            }
            a = {}
        }
    ...
    function Ip(a, b, c, d) {
        Jp(a, b, c, d, function(e, f) {
            e = e.document;
            for (var g = void 0, h = 0; !g || e.getElementById(g + (Q(Gf) ? "_host" : "_anchor"));) g = "aswift_" + h++;
            e = g;
            g = Number(f.google_ad_width || 0);
            f = Number(f.google_ad_height || 0);
            if (Q(Gf)) h = Xc("DIV"), h.id = e + "_host", Bn(h, g, f), h.style.display = "inline-block", f = {
                Qa: h,
                Ua: h
            };
            else {
    ...
    function Jp(a, b, c, d, e) {
        ...
        a.google_sv_map[e] = b;
        d = a.document.getElementById(e + (Q(Gf) ? "_host" : "_anchor")) ? function(h) {
            return h()
        } : function(h) {
        ...
        Fp(a, function() {
            if (Q(Ff)) {
                ...
                if (!h || !k)
                    if (k = a.document.getElementById(String(b.google_async_iframe_id) + (Q(Gf) ?
                            "_host" : "_anchor")), h = a.document.getElementById(String(b.google_async_iframe_id) + (Q(Gf) ? "_host" : "_expand")), null == k || null == h) throw Error("no_ins");
                h = {
                    pubWin: a,
                    vars: b,
                    outerInsElement: h,
    ...
    function Mp(a) {
        ep();
        fp(Yl(), Xb(a, 8)) || Wj(779, function() {
            var b = window;
            b = void 0 === b ? window : b;
            b = Q(b.PeriodicSyncManager ? Kf : Lf);
            var c = Q(Nf);
            b = new cp(!0, b, c);
            0 < R(Qf) ? L.google_trust_token_operation_promise = kp(b) : kp(b)
        })();
        a = Ap();
    ...
    function Op(a, b) {
        if (a.getAttribute("src")) {
            ...
            (c = Tc(c)) && (b.google_ad_client = Np("google_ad_client", c))
        }
        a = a.attributes;
        c = a.length;
        for (var d = 0; d < c; d++) {
            ...
            if (/data-/.test(e.name)) {
                ...
                b.hasOwnProperty(f) || (e = Np(f, e.value), null !== e && (b[f] = e))
            }
        }
    }
    ...
    function Qp(a, b, c, d) {
        ...
        if (!Q(nf) && 488 > og(c)) {
            ...
            d = g.location && "#ftptohbh" === g.location.hash ? 2 : Dm(g.location, "google_responsive_slot_preview") || Q(xf) ? 1 : Q(wf) ? 2 : $l(g, 1, h, d) ? 1 : 0;
            if (g = 0 !== d) b: if (b.google_reactive_ad_format || Q( of ) && b.google_ad_resize || mo(c, b) || Bi(a, b)) g = !1;
                else {
        ...
        if (e = mo(c, b)) oo(e, a, b, c, d);
            ...
            if (Bi(a, b)) {
                ...
                b.google_responsive_auto_format = Pp(c)
            } else Ai(a.style, b);
    ...
    var Tp = ja(["(a=0)=>{let b;const c=class{};}"]);
    ...
    function dq(a, b, c) {
        var d = window;
        d.google_spfd || (d.google_spfd = Qp);
    ...
    function eq(a, b, c) {
        ...
        if (f && f.Ka && "on" != b.google_adtest && !e) {
            ...
            if (!f.sa || f.sa && ((0 == g ? null : e / g) || 0) >= f.sa) return a.className += " adsbygoogle-ablated-ad-slot", c = c.google_sv_map = c.google_sv_map || {}, d = Ba(a), b.google_element_uid = d, c[b.google_element_uid] = b, a.setAttribute("google_element_uid", d), "slot" == f.Db && (null !== jd(a.getAttribute("width")) &&
    ...
    function fq(a) {
        ...
        for (var c = 0, d = b[c]; c < b.length; d = b[++c]) {
            var e = d;
            if (bq(e) && "reserved" != e.dataset.adsbygoogleStatus && (!a || d.id === a)) return d
        }
        return null
    }
    ...
    function nq(a, b) {
        ...
        if (c) {
            ...
            if (d.head_tag_slot_vars) oq(c);
                ...
                var g;
                e.google_adbreak_test || (null == (g = Zb(b, Il, 13, Mb)) ? 0 : E(g, 3)) && Q(Cf) ? pq(f, a) : Vp(function() {
                    pq(f, a)
                })
            }
        }
    ...
    function lq(a, b, c, d) {
        ...
        Kb(d, 14) && rq(a, Nb(Wl(d), 1), Xb(d, 2));
        var e = qq(a);
        if (0 !== e) Q(tf) && (d = nm(), d.first_slotcar_request_processing_time || (d.first_slotcar_request_processing_time = Date.now(), d.adsbygoogle_execution_start_time = Ka)), null == Yp ? (sq(a), Zp.push(a)) : 3 === e ? Vj(787, function() {
            Yp.handleAdConfig(a)
        }) : Yj(730, Yp.handleAdBreak(a));
        else {
            Ka = (new Date).getTime();
            Cp(c, d, tq(a));
            uq();
            ...
            if (e) vq(a, d);
                ...
                c && (f || (vq(c, d), V(L).skip_next_reactive_tag = !0), Q(Af) && f && xq(c));
    ...
    function rq(a, b, c) {
        Q(pf) && !yq && (yq = !0, (a = tq(a)) || (a = Ho(L)), Xj("predictive_abg", {
            a_c: a,
            p_c: b,
            b_v: c
        }, .01))
    ...
    function wq(a) {
        if (a) {
            if (!bq(a) && (a.id ? a = fq(a.id) : a = null, !a)) throw new U("'element' has already been filled.");
            if (!("innerHTML" in a)) throw new U("'element' is not a good DOM element.");
        } else if (a = fq(), !a) throw new U("All ins elements in the DOM with class=adsbygoogle already have ads in them.");
        return a
    }
    ...
    function pq(a, b) {
        b = Im(wc(zc(yc(b.Cb).toString()), Sf() ? {
            bust: Sf()
        } : {})).then(function(c) {
            null == Yp && (c.init(a), Yp = c, Fq())
        });
        Yj(723, b);
    ...
    function Fq() {
        for (var a = u(r($p, "keys").call($p)), b = a.next(); !b.done; b = a.next()) {
            b = b.value;
            var c = $p.get(b); - 1 !== c && (x.clearTimeout(c), $p.delete(b))
        }
        a = {};
        for (b = 0; b < Zp.length; a = {
                ia: a.ia,
                ea: a.ea
            }, b++) $p.has(b) || (a.ea = Zp[b], a.ia = qq(a.ea), Vj(723, function(d) {
            return function() {
                3 === d.ia ? Yp.handleAdConfig(d.ea) : 2 === d.ia && Yj(730, Yp.handleAdBreakBeforeReady(d.ea))
            }
        }(a)))
    }
    ...
    function sq(a) {
        var b = Zp.length;
        if (2 === qq(a) && "preroll" === a.type && null != a.adBreakDone) {
            -1 === aq && (aq = Date.now());
    ...
    (function(a, b, c, d) {
        ...
        Vj(166, function() {
            ...
            Sp();
            if ((!Pa() || 0 <= Ma(Sa(), 11)) && (null == (L.Prototype || {}).Version || !Q(mf))) {
                Uj(Q(Jf));
                Mp(e);
                ml();
                try {
                ...
                if (!h || !h.loaded) {
                    ...
                    h &&
                        (k.onload = h.onload);
                    (f = Hp(g)) && document.documentElement.appendChild(f);
                    f = Up();
                    Xj("modern_js", {
                        fy: D(e, 1, 0),
                        supports: f[0],
